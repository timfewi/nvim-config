...
function M.apply(name, palette)
	...
	set_highlights({
		...
		DiagnosticFloatingInfo = { fg = p.blue, bg = p.bg_float },
		...
		LspInlayHint = { fg = p.fg_muted, bg = p.bg_alt, italic = true },
		...
		ModeMsg = { fg = p.function_name, bold = true },
		MoreMsg = { fg = p.function_name },
		NonText = { fg = p.border },
		...
		PmenuMatch = { fg = p.function_name, bg = p.bg_float, bold = true },
		PmenuMatchSel = { fg = p.function_name, bg = p.bg_highlight, bold = true },
		PmenuSbar = { bg = p.border_subtle },
		PmenuSel = { fg = p.fg, bg = p.bg_highlight },
		PmenuThumb = { bg = p.fg_muted },
		PreCondit = { fg = p.blue, italic = true },
		PreProc = { fg = p.blue },
		Question = { fg = p.blue_bright },
		...
		Substitute = { fg = p.bg, bg = p.function_name },
		TabLine = { fg = p.fg_muted, bg = p.bg_alt },
		TabLineFill = { bg = p.bg_alt },
		TabLineSel = { fg = p.fg, bg = p.bg, bold = true },
		Tag = { fg = p.blue },
		Title = { fg = p.function_name, bold = true },
		Todo = { fg = p.bg, bg = p.function_name, bold = true },
		Type = { fg = p.type },
		Typedef = { fg = p.type },
	...
	set_highlights({
		...
		["@label"] = { fg = p.magenta },
		["@markup.heading"] = { fg = p.function_name, bold = true },
		["@markup.italic"] = { italic = true },
		["@markup.link"] = { fg = p.blue_bright, underline = true },
		...
		["@variable"] = { fg = p.white },
		["@variable.builtin"] = { fg = p.blue_bright, italic = true },
		["@variable.member"] = { fg = p.cyan },
		["@variable.parameter"] = { fg = p.sand, italic = true },
	})
	...
	set_highlights({
		...
		BlinkCmpLabelMatch = { fg = p.function_name, bg = p.bg_float, bold = true },
		...
		DapUIBreakpointsPath = { fg = p.blue_bright },
		DapUIDecoration = { fg = p.function_name },
		DapUIFloatBorder = { fg = p.border, bg = p.bg_float },
		DapUILineNumber = { fg = p.gold },
		DapUIModifiedValue = { fg = p.gold, bold = true },
		DapUIScope = { fg = p.function_name, bold = true },
		DapUISource = { fg = p.cyan_alt },
		DapUIStoppedThread = { fg = p.function_name, bold = true },
		...
		DiffviewFilePanelCounter = { fg = p.function_name },
		...
		DiffviewFilePanelTitle = { fg = p.function_name, bold = true },
		DiffviewPrimary = { fg = p.function_name },
		...
		FidgetTitle = { fg = p.function_name, bold = true },
		...
		MiniStatuslineModeInsert = { fg = p.bg, bg = p.function_name, bold = true },
		...
		NeoTreeFloatTitle = { fg = p.function_name, bg = p.bg_alt, bold = true },
		...
		NeoTreeSymbolicLinkTarget = { fg = p.blue, italic = true },
		...
		TelescopeMatching = { fg = p.function_name, bold = true },
		...
		TelescopePromptPrefix = { fg = p.function_name, bg = p.bg_float },
		TelescopePromptTitle = { fg = p.bg, bg = p.function_name, bold = true },
		...
		TelescopeSelectionCaret = { fg = p.function_name, bg = p.bg_highlight },
		TodoBgFIX = { fg = p.bg, bg = p.error, bold = true },
		TodoBgHACK = { fg = p.bg, bg = p.magenta, bold = true },
		TodoBgNOTE = { fg = p.bg, bg = p.function_name, bold = true },
